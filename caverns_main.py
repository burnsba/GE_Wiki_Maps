...
def caverns_specific(tilePlanes, currentTiles, plt, axs):
...
def main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GROUP_NO, path):
    ...
    # Call specific code
    caverns_specific(tilePlanes, currentTiles, plt, axs)
...
main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GRP_DOWNSTAIRS, "caverns_main_downstairs")
main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GRP_MAIN_UPSTAIRS, "caverns_main_upstairs")
main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GRP_UPSTAIRS_LOWER_CATWALK, "caverns_upstairs_lower_catwalk")
main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GRP_SPIRAL_MIDDLE, "caverns_spiral_middle")
main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GRP_OBJ_A_AREA, "caverns_objective_a_area")